...
<div class="img-container">
  <Box
    ...
    href="/services/orchestration-monitoring/orchestration-engine"
  />
  <Box
    name="Service Mesh Automation (Orchestration, ORC)"
    img="/img/service_3.png"
    href="/services/orchestration-monitoring/service-mash"
  />
  <Box
    name="Continuous Automated Monitoring (CAM)"
    img="/img/monitoring.png"
    href="/services/orchestration-monitoring/continuous-automated"
  />
</div>
