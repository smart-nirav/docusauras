...
<div class="img-container">
  ...
  <Box
    ...
    img="/img/icam_2.png"
    href="./organisation-credential"
  />
  <Box
    name="Personal CredentialManager (PCM)"
    img="/img/icam_3.png"
    href="./personal-credential"
  />
  <Box name="Trust Services API (TSA)" img="/img/icam_4.png" href="./trust-service" />
  <Box name="Notarisation Service (NOT)" img="/img/icam_5.png" href="./notarisation" />
  <Box name="Trust Management Infrastructure (TRAIN)" img="" href="./trust-management" />
</div>
