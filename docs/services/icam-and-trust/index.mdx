...
<div class="img-container">
  <Box
    ...
    img="/img/icam_1.png"
    href="/services/icam-and-trust/authentication"
  />
  <Box
    name="Organisation CredentialManager (OCM)"
    img="/img/icam_2.png"
    href="/services/icam-and-trust/organisation-credential"
  />
  <Box
    name="Personal CredentialManager (PCM)"
    img="/img/icam_3.png"
    href="/services/icam-and-trust/personal-credential"
  />
  <Box name="Trust Services API (TSA)" img="/img/icam_4.png" href="/services/icam-and-trust/trust-service" />
  <Box name="Notarisation Service (NOT)" img="/img/icam_5.png" href="/services/icam-and-trust/notarisation" />
  <Box name="Trust Management Infrastructure (TRAIN)" img="/img/trust.png" href="/services/icam-and-trust/trust-management" />
</div>
